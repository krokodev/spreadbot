    ...
    public partial class MipConnector
    {
        public partial class SftpHelper
        {
            ...
            private static MipResponse<MipTestConnectionResult> DoTestConnection(string password)
            {
                ...
                return new MipResponse<MipTestConnectionResult>(true, MipStatusCode.TestConnectionSuccess,
            ...
            private static MipResponse<MipSendZippedFeedFolderResult> DoSendZippedFeed(string feed, Guid reqId)
            {
                ...
                {
                    return new MipResponse<MipSendZippedFeedFolderResult>(false, MipStatusCode.SendZippedFeedFail,
                        exception);
                }
                return new MipResponse<MipSendZippedFeedFolderResult>(true, MipStatusCode.SendZippedFeedSuccess,
